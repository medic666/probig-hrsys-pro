<template>
  <el-dialog :model-value="visible" :title="isEdit ? '编辑职务事件' : '新增职务事件'" width="640px" @close="handleClose">
...
import { createPositionEvent, updatePositionEvent } from '@/api/position-event'
...
const isEdit = props.event?.id != null
